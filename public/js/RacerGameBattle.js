...
function racerGameBattle(mode) {
  ...
  function setEmoteFirst() {
    ...
    if(currentEmoteFirst.provider === "7tv") emoteImg[0].src = `https://cdn.7tv.app/emote/${currentEmoteFirst.id}/3x.webp`
  ...
  function setEmoteLast() {
    ...
    if(currentEmoteLast.provider === "7tv") emoteImg[1].src = `https://cdn.7tv.app/emote/${currentEmoteLast.id}/3x.webp`
  }
